...
class GoogleSummaryClient(SummaryClient):
    ...
    async def summarize(self, prev_summary: str, messages: List[Dict[str, Any]], *, token_budget: Optional[int] = None, request_id: Optional[str] = None) -> str:
        ...
        system = (
            ...
            "LIMITS: For each section, keep at most 7 bullcondensingets. If adding new bullets would exceed 7, remove bullets from the TOP (oldest) and append new bullets at the BOTTOM (newest).\n"
        ...
        if token_budget and token_budget > 0:
            ...
            gen_cfg["maxOutputTokens"] = max(300, min(2048, token_budget))
